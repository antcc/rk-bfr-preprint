...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=.6\textwidth]{reg_emcee_non_gp}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=.6\textwidth]{clf_emcee_non_gp}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=.75\textwidth]{beta_tau_trace_3}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=.75\textwidth]{beta_tau_trace_4}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=.96\textwidth]{mixture_dependence_acc_p}
